...
@CommandParameters(description = "Shows information about SuperFreedomMod or reloads it", usage = "/<command> [reload]", aliases = "sfm")
public class Command_totalfreedommod extends FreedomCommand
{
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        msg("SuperFreedomMod for 'Super Freedom', an all-op server.", ChatColor.GOLD);
        msg("Running on SuperFreedom.", ChatColor.GOLD);
        msg("Created by _Super47.", ChatColor.GOLD);
        ...
        msg("Visit " + ChatColor.AQUA + "http://github.com/SuperFreedom/SuperFreedomMod"

...
@CommandParameters(description = "Temporarily eliminate someone.", usage = "/<command> [playername] [duration] [reason]")
public class Command_tempban extends FreedomCommand
{
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        final StringBuilder message = new StringBuilder("Temporarily eliminated " + player.getName());
        ...
        String reason = "Eliminated by " + sender.getName();
        if (args.length >= 3)
        {
